...
class Config(object):
    ...
    def setup_parser(self):
        ...
        parser.add_argument('-train_data_path', help='train data path', type=str, default='../datasets/processed/qa_train_task1.jsonl')
        parser.add_argument('-eval_data_path', help='eval data path', type=str, default='../datasets/processed/qa_dev_task1.jsonl')
        parser.add_argument('-test_data_path', help='test data path', type=str, default='../datasets/raw/datasets_test_track1.jsonl')
        ...
        parser.add_argument('-test_answer_path', help='test answer path', type=str, default='../datasets/res/task1.txt')
