...
if __name__ == "__main__":
    gold_file = "../raw/datasets_dev.jsonl"
    # fake
    pred_file = "./fake_dev.txt"
    print('fake dev score:', evaluation(gold_file, pred_file))

    # roberta
    pred_file = "robert_dev_0531.txt"
    print('!!best score!! robert dev score', evaluation(gold_file, pred_file))
    
    # roberta-eda
    pred_file = "pred_dev_0531.txt"
    print('!!best score!! robert dev score', evaluation(gold_file, pred_file))
